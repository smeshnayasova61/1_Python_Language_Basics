...
# строками текстовый файл, в котором каждая строка будет содержать
...
# получила убытки, также добавить её в словарь (со значением
# убытков).
...
with open('my_ex7.json', 'w', encoding='utf-8') as write_f, open('text_7.txt',encoding='utf-8') as f_obj:
    #работаем в двух менеджерах контекста
